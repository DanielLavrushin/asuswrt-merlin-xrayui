<template>
    <table width="100%" bordercolor="#6b8fa3" class="FormTable" v-if="dns">
        <thead>
            <tr>
                <td colspan="2">{{ $t('components.Dns.title') }}
        ...
        <tbody>
            ...
            <tr v-if="dns.servers">
                <th> {{ $t('components.Dns.label_servers') }}
            ...
            <tr v-if="engine.mode == 'client'">
                <th> {{ $t('components.Dns.label_client_ip') }}
            ...
            <tr>
                <th> {{ $t('components.Dns.label_query_strategy') }}
            ...
            <tr>
                <th> {{ $t('components.Dns.label_disable_cache') }}
            ...
            <tr>
                <th> {{ $t('components.Dns.label_disable_fallback') }}
            ...
            <tr>
                <th> {{ $t('components.Dns.label_fallback_if_match') }}
