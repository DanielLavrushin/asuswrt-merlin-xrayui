<template>
    <div class="formfontdesc">
        <p>
            The Shadowsocks protocol is compatible with most other implementations of Shadowsocks. The server supports
...
import { XrayShadowsocksInboundObject, XrayInboundObject, XrayProtocol, XrayOptions } from "../../modules/XrayConfig"
