<template>
  <modal ref="importModal" title="Import configuration" width="700px">
    <div class="formfontdesc">
      <p>Here you can import a configuration from a QR code or a protocol URL.</p>
      <table class="FormTable modal-form-table">
        <tbody>
          <tr>
            <th>
              QR Code
              <hint> Try to print screen your QR code and xrayui will try to read it. </hint>
            </th>
            <td>
          ...
          <tr>
            <th>
              Outbound Proxy Uri
              <hint> You can paste here the URL of the protocol here. Usually they start with `vless://` or `vmess://`. </hint>
            </th>
            <td>
          ...
          <tr>
            <th>
              ...
              <hint>
                If you select this option, xrayui will overwrite your current configuration with the most suitable default configuration for the imported protocol.
                <hr />
                A default Routing rule will be created to test the proxy outbound connection. After importing and applying the configuration, you can try to open the `https://www.myip.com/`. You should see the IP of the server you are connected to.
                <hr />
        ...
        <tbody v-show="completeSetup">
          <tr>
            <th>
              Unblock
              <hint>
                Select the services you want to unblock. This will automatically create a `routing rule` that channels their traffic through the proxy.
                <hr />
                It's recommended to only choose services that are blocked in your region. You'll be able to add, update, or delete these rules later in the `Routing` section.
              </hint>
            </th>
          ...
          <tr>
            <th>
              ...
              <hint>
                Check this box if you have IoT devices on your router network, like `Smart TVs`, `Xbox`, `PlayStation`, or other devices you prefer not to affect with X-RAY.
                <hr />
                This option limits the rerouted traffic to X-RAY via your router, reducing the risk of disconnecting these devices. Later You can adjust this option in the Routing section (`Ports Bypass/Redirect Policy`).
                <hr />
