<template>
  <modal width="755" ref="modalList" :title="$t('components.RulesModal.modal_title')">
        ...
        <tr v-for="(r, index) in rules.filter((r) => !r.isSystem())" :key="index">
          ...
          <td>
            ...
            <span class="row-buttons">
              <input class="button_gen button_gen_small" type="button" value="&#8593;" :title="$t('labels.redorder')"
                @click="reorderRule(r)" v-if="index > 0" />
              <input class="button_gen button_gen_small" type="button" :value="$t('labels.edit')"
                @click.prevent="editRule(r)" />
              <input class="button_gen button_gen_small" type="button" value="&#10005;" :title="$t('labels.delete')"
    ...
    <template v-slot:footer>
      <input class="button_gen button_gen_small" type="button" :value="$t('components.RulesModal.add_new_rule')"
