            ...
            <tbody v-if="proxy.settings.noises">
                <tr>
                    ...
                    <td>
                        ...
                        <modal width="500" ref="modalNoises"
                            :title="$t('components.FreedomOutbound.modal_udp_noise_title')">
                                    ...
                                    <tr v-for="(noise, index) in proxy.settings.noises" :key="index">
                                        ...
                                        <td>
                                            <input class="button_gen button_gen_small" type="button"
                                                :value="$t('labels.edit')" @click.prevent="modal_noise_open(noise)" />
                                            <input class="button_gen button_gen_small" type="button"
                            ...
                            <template v-slot:footer>
                                ...
                                <input class="button_gen button_gen_small" type="button" :value="$t('labels.close')"
                                    @click.prevent="modal_noises_close()" />
                            </template>
                        </modal>
                        <modal width="400" ref="modalNoise"
                            :title="$t('components.FreedomOutbound.modal_udp_noise_entry_title')">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <th>
                                            ...
                                            <hint v-html="$t('components.FreedomOutbound.hint_udp_noise_packet')">
                                            </hint>
                                        </th>
                                        <td>
