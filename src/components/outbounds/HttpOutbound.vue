    ...
    <table width="100%" bordercolor="#6b8fa3" class="FormTable modal-form-table">
      ...
      <tbody>
        ...
        <tr>
          <th>Proxy address</th>
          <td>
            <input type="text" maxlength="15" class="input_20_table" v-model="proxy.settings.servers[0].address" onkeypress="return validator.isIPAddr(this, event);" autocomplete="off" autocorrect="off" autocapitalize="off" />
