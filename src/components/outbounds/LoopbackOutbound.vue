      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            ...
            <span class="hint-color" v-if="!inbounds.length">This tag can be used as inboundTag in routing rules, all traffics going through this outbound can be rerouted with routing rules with corresponding inbound tag</span>
            <span class="hint-color">Use as an inbound tag for routing.</span>
          </td>
        </tr>
      </tbody>
    </table>
