...
class EngineResponseConfig {
  ...
  public xray?: { ipsec: boolean; debug: boolean; clients_check: boolean; test: string; uptime: number; ui_version: string; core_version: string; profile: string; profiles: string[]; backups: string[]; github_proxy: string; dnsmasq: boolean; logs_max_size: number; logs_dor: boolean; skip_test: boolean };
